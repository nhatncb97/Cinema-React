                    ...
                    <div id="home" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner text-center home-inner" role="listbox">
                            <div className="item active">
                                <img src="/img/img_blog/1.jpg" alt="Brandi Img 1" width="100%" />
                            </div>
                            <div className="item">
                                <img src="/img/img_blog/2.jpg" alt="Brandi Img 2" width="100%" />
                            </div>
                            <div className="item">
                                <img src="/img/img_blog/3.jpg" alt="Brandi Img 3" width="100%" />
                            </div>
                        </div>
                    </div>
                </div>
