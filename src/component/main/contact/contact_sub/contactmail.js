                    ...
                    <div style={{marginLeft: '15%'}}>
                        ...
                        <div style={{marginTop: 30}}>
                            <form id="reply_form" action="post">
                                ...
                                <br />
                                <div>
                                    <textarea style={{padding: 8, width: '90%', height: 90, borderRadius: 5}} id="contact_form_message" className="text_field contact_form_message" name="message" placeholder="Message" required data-error="Please, write us a message." defaultValue={""} />
                                </div>
                                <br />
                                <div>
                                    {/* Submit*/}
